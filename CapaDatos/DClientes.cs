    ...
    public class DClientes
    {
        ...
        public string Guardar(int opcion, EClientes oEntidad)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add("@nro_documento_cl", SqlDbType.VarChar).Value = oEntidad.Nro_documento_cl;
                Comando.Parameters.Add("@razon_social_cl", SqlDbType.VarChar).Value = oEntidad.Razon_social_cl;
        ...
        public string Eliminar(int codigo)
        {
            ...
            try
            {
                ...
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@codigo_cl", SqlDbType.Int).Value = codigo;
                SqlCon.Open();
