...
namespace CapaDatos
{
    public class DDistritos
    {
        public DataTable Listado(int codigo_de, int codigo_po, int estado, string texto)
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("spListado_Distritos", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@codigo_de", SqlDbType.Int).Value = codigo_de;
                Comando.Parameters.Add("@codigo_po", SqlDbType.Int).Value = codigo_po;
        ...
        public string Guardar(int opcion, EDistritos oEntidad)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                SqlCon = Conexion.GetInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("spGuardar_Distritos", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                ...
                Comando.Parameters.Add("@descripcion", SqlDbType.VarChar).Value = oEntidad.Descripcion_di;
        ...
        public string Eliminar(int codigo)
        {
            ...
            {
                SqlCon = Conexion.GetInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("spEliminar_Distritos", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
