    ...
    public class DAlmacenes
    {
        public DataTable Listado(int estado, string texto)
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("spListado_Almacenes", SqlCon);
        ...
        public string Guardar(int opcion, EAlmacenes oEntidad)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                SqlCon = Conexion.GetInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("spGuardar_Almacenes", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@opt_guarda", SqlDbType.Int).Value = opcion;
                Comando.Parameters.Add("@codigo", SqlDbType.Int).Value = oEntidad.Codigo_al;
                Comando.Parameters.Add("@descripcion", SqlDbType.VarChar).Value = oEntidad.Descripcion_al;
        ...
        public string Eliminar(int codigo)
        {
            ...
            {
                SqlCon = Conexion.GetInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("spEliminar_Almacenes", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
