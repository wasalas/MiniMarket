...
namespace CapaPresentacion
{
    public partial class frmClientes : Form
    {
        ...
        private void btn_eliminar_Click(object sender, EventArgs e)
        {
            ...
            Eliminar(oDatos.Codigo_cl, oDatos.Razon_social_cl);
        }
        private void btn_reporte_Click(object sender, EventArgs e)
        {
            ...
            Reportes.frmRepClientes frm = new Reportes.frmRepClientes();
        ...
        private void ObtenerDatosForm()
        {
            ...
            if (this.Cantidad_registros == 0)
            {
                oDatos.Codigo_cl = 0;
                oDatos.Codigo_tdi = 0;
                oDatos.Nro_documento_cl = "";
                oDatos.Razon_social_cl = "";
                oDatos.Nombres = "";
                oDatos.Apellidos = "";
                oDatos.Codigo_sx = 0;
                oDatos.Email = "";
            ...
            else
            {
                ...
                oDatos.Nro_documento_cl = Convert.ToString(dgDatos.CurrentRow.Cells["nro_documento_cl"].Value);
                oDatos.Razon_social_cl = Convert.ToString(dgDatos.CurrentRow.Cells["razon_social_cl"].Value);
