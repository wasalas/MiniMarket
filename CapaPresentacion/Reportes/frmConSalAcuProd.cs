...
{
    public partial class frmConSalAcuProd : Form
    {
        public frmConSalAcuProd()
        {
            InitializeComponent();
        }

        private void frmConSalAcuProd_Load(object sender, EventArgs e)
        {
            ...
            this.spConsolidado_SalAcuPorProdTableAdapter.Fill(this.dS_Reportes.spConsolidado_SalAcuPorProd, fecha_ini: dt_fecini, fecha_fin: dt_fecfin);
