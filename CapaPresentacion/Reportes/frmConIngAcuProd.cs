...
{
    public partial class frmConIngAcuProd : Form
    {
        public frmConIngAcuProd()
        {
            InitializeComponent();
        }

        private void frmConIngAcuProd_Load(object sender, EventArgs e)
        {
            ...
            this.spConsolidado_IngAcuPorProdTableAdapter.Fill(this.dS_Reportes.spConsolidado_IngAcuPorProd, fecha_ini: dt_fecini, fecha_fin: dt_fecfin);
