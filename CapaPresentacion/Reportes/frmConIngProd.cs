...
{
    public partial class frmConIngProd : Form
    {
        public frmConIngProd()
        {
            InitializeComponent();
        }

        private void frmConIngProd_Load(object sender, EventArgs e)
        {
            ...
            this.spConsolidado_IngPorProdTableAdapter.Fill(this.dS_Reportes.spConsolidado_IngPorProd, fecha_ini: dt_fecini, fecha_fin: dt_fecfin);
