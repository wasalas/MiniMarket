...
{
    public partial class frmProveedores_ed : Form
    {
        // ***********************************************************************************
        #region "Mis Variables"
        private int Estado_guarda;
        private EProveedores oDatos;
        public bool GraboDatos = false;
        #endregion

        // ***********************************************************************************
        #region "Metodos del Form"
        public frmProveedores_ed(int Opcion, EProveedores Datos)
        {
            InitializeComponent();
            this.Estado_guarda = Opcion;
            this.oDatos = Datos;
        }
        private void frmProveedores_ed_Load(object sender, EventArgs e)
        {
            ...
            this.cbo_rubro.DataSource = NRubros.Listado(1, "");
            this.cbo_rubro.ValueMember = "codigo_ru";
            this.cbo_rubro.DisplayMember = "descripcion_ru";
            ...
            */
            ...
            if (this.Estado_guarda == 1)
            {
                ...
                this.cbo_rubro.SelectedValue = 0;
                this.txt_email.Text = "";
            ...
            {
                this.txt_codigo_pv.Text = oDatos.Codigo_pv.ToString();
                this.cbo_tip_doc_ide.SelectedValue = oDatos.Codigo_tdi;
                this.txt_num_doc_ide.Text = oDatos.Nro_documento_pv;
                this.txt_raz_soc.Text = oDatos.Razon_social_pv;
                this.txt_apellidos.Text = oDatos.Apellidos;
                this.txt_nombres.Text = oDatos.Nombres;
                this.cbo_sexo.SelectedValue = oDatos.Codigo_sx;
                this.cbo_rubro.SelectedValue = oDatos.Codigo_ru;
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            oDatos.Nro_documento_pv = this.txt_num_doc_ide.Text.Trim().ToUpper();
            oDatos.Razon_social_pv = this.txt_raz_soc.Text.Trim().ToUpper();
            ...
            oDatos.Codigo_ru = Convert.ToInt32(this.cbo_rubro.SelectedValue);
            ...
            if (oDatos.Razon_social_pv == String.Empty)
            {
            ...
            {
                Rpta = NProveedores.Guardar(this.Estado_guarda, this.oDatos);
                if (Rpta == "OK")
                {
