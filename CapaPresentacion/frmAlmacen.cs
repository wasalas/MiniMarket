...
namespace CapaPresentacion
{
    public partial class frmAlmacen : Form
    {
        ...
        private static frmAlmacen _instancia;
        private EAlmacenes oDatos = new EAlmacenes();
        ...
        private void btn_reporte_Click(object sender, EventArgs e)
        {
            ...
            Reportes.frmRepAlmacenes frm = new Reportes.frmRepAlmacenes();
        ...
        private void CargaDatos()
        {
            ...
            dgDatos.DataSource = NAlmacenes.Listado(p_estado, this.texto_buscar);
        ...
        private void Editar()
        {
            frmAlmacen_ed frm = new frmAlmacen_ed(this.Estado_guarda, oDatos);
            frm.ShowDialog();

            if (frm.GraboDatos == true)
            {
                CargaDatos();
                BuscarEnGrid(oDatos.Codigo_al);
            }
        }
        ...
        private void ObtenerDatosForm()
        {
            ...
            {
                oDatos.Codigo_al = 0;
                oDatos.Descripcion_al = "";
                oDatos.Estado = 0;
            }
            else
            {                
                oDatos.Codigo_al = Convert.ToInt32(dgDatos.CurrentRow.Cells["codigo_al"].Value);
                oDatos.Descripcion_al = Convert.ToString(dgDatos.CurrentRow.Cells["descripcion_al"].Value);
        ...
        public static frmAlmacen GetInstancia()
        {
            if (_instancia == null)
                _instancia = new frmAlmacen();
            else
                _instancia.Activate();
